/*! Select2 4.0.11 | https://github.com/select2/select2/blob/master/LICENSE.md */ ! function(n) {
    ...
    var e = function() {
            ...
            function c(e, t) {
                var n, i, r, o, s, a, l, c, u, d, p, h = t && t.split("../index.html"),
                    f = y.map,
                    g = f && f["*"] || {};
                if (e) {
                    for (s = (e = e.split("../index.html")).length - 1, y.nodeIdCompat && w.test(e[s]) && (e[s] = e[s].replace(w, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++)
                ...
                if ((h || g) && f) {
                    for (u = (n = e.split("../index.html")).length; 0 < u; u -= 1) {
                        if (i = n.slice(0, u).join("../index.html"), h)
                            for (d = h.length; 0 < d; d -= 1)
                                if (r = (r = f[h.slice(0, d).join("../index.html")]) && r[i]) {
                                    o = r, a = u;
                                    break
                                }
                        if (o) break;
                        !l && g && g[i] && (l = g[i], c = u)
                    }!o && l && (o = l, a = c), o && (n.splice(0, a, o), e = n.join("../index.html"))
                }
                return e
            }
