...
! function() {
    ...
    var o, i, r, n, a, s, d, l = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif",
        c = {
    ...
    c.WidgetAbstract.prototype = {
        ...
        addWrapperFrame: function(e) {
            ...
            return t.id = this.id + "-wrapper", t.style.cssText = "position: relative;box-sizing: content-box;margin: 0 auto !important;padding: 0 !important;font-family: " + l + ";", t.style.width = c.WidgetAbstract.prototype.width.call(this), t.style.height = c.WidgetAbstract.prototype.height.call(this), t.appendChild(e), t
        }
        ...
        render: function() {
            ...
            e.pathname = "/eventswidgetembed/", c.addUrlParams(e, {
                currency: this.options.currency,
                importance: this.options.importance
            }), this.options.type = "events", c.addUrlParams(e, c.generateUtmForUrlParams(this.options));
            const t = document.createElement("iframe");
            return t.title = c.getWidgetTitleAttribute(this.options.iframeTitle, this.widgetId), t.lang = this.options.iframeLang || "en", t.width = this.options.width, this.options.height && (t.height = this.options.height), t.setAttribute("frameBorder", "0"), t.setAttribute("scrolling", "no"), t.src = e, t
        }
        ...
        render: function() {
            ...
            e["page-uri"] = c.getPageUriString(), this.options.type = "symbol-overview";
        ...
        create: function() {
            ...
            var e = this;
            let t = this.iframe;
            this.options.noLogoOverlay || (t = c.WidgetAbstract.prototype.addWrapperFrame.call(this, t)), h(t, this.options);
            var o = document.getElementById("tradingview-copyright");
            o && o.parentElement && o.parentElement.removeChild(o), this.postMessage = c.postMessageWrapper(this.iframe.contentWindow, this.id), c.bindEvent(this.iframe, "load", (function() {
        ...
        generateUrl: function(e) {
            ...
            var r = c.getHost(e);
            const n = new URL(r + t);
            n.searchParams.append("hideideas", "1"), n.searchParams.append("overrides", JSON.stringify(g(e.overrides, {}))), n.searchParams.append("enabled_features", JSON.stringify(g(e.enabled_features, []))), n.searchParams.append("disabled_features", JSON.stringify(g(e.disabled_features, []))), e.locale && n.searchParams.append("locale", e.locale);
        ...
        create: function() {
            ...
            var o, i = this;
            h(t, this.options), o = document.getElementById(this.id), c.bindEvent(o, "load", (function() {
                var e;
        ...
        render: function() {
            ...
            }, !0), this.options.type = "chart", c.addUrlParams(e, c.generateUtmForUrlParams(this.options));
            const t = document.createElement("iframe");
            return t.title = c.getWidgetTitleAttribute(this.options.iframeTitle, this.widgetId), t.lang = this.options.iframeLang || "en", t.id = this.id, t.style.cssText = "width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;", t.setAttribute("frameBorder", "0"), t.setAttribute("allowTransparency", "true"), t.setAttribute("scrolling", "no"), t.setAttribute("allowfullscreen", "true"), t.src = e.href, t
        },
        toggleFullscreen: function(e) {
            var t = document.getElementById(this.id);
            document.fullscreenElement === t ? document.exitFullscreen() : t.requestFullscreen()
        }
    }, c.postMessageWrapper = (i = {}, r = {}, n = {}, a = 0, s = 0, d = "TradingView", window.addEventListener && window.addEventListener("message", (function(e) {
        var t;
        try {
            t = JSON.parse(e.data)
        } catch (e) {
        ...
        if (t && t.provider && t.provider === d)
            ...
            } else if ("on" === t.type) i[t.client_id] && i[t.client_id][t.id] && (i[t.client_id][t.id].call(t, t.data), delete i[t.client_id][t.id]);
        else if ("post" === t.type) {
            if (!r[t.name]) return;
            r[t.name].forEach((function(e) {
        ...
        if (o) {
            ...
            if (i) {
                ...
                if (r) {
                    ...
                    if (n) try {
                        const e = new URL(n);
                        c.addUrlParams(e, c.generateUtmForUrlParams(t)), r.setAttribute("href", e.toString())
                    } catch (e) {
                        console.log(`Cannot update link UTM params, href="${n}"`)
                    }
                }
            }
        } else document.currentScript.parentNode.insertBefore(e, document.currentScript.nextSibling);
