(() => {
    ...
    function i(r) {
        ...
        class u {
            ...
            _replaceScript(i) {
                ...
                const u = s.nonce || s.getAttribute("nonce"),
                    ...
                    p = g.querySelector(".tradingview-widget-copyright");
                ...
                const C = this.hasCopyright() ? `calc(100% - ${w})` : "100%",
                    T = location.hostname,
                    _ = p ? "widget_new" : "widget",
                    A = this.widgetUtmName();
                this.settings.utm_source = T, this.settings.utm_medium = _, this.settings.utm_campaign = A, this._updateCopyrightHrefParams(T, _, A);
                const k = this.settings.iframeTitle || `${this.widgetId.replace("-"," ")} TradingView widget`,
                    E = this.settings.iframeLang || "en";
                this.iframe = this._createIframe(C, c, a, k, E), this._addCSPErrorListener(c), u && this.iframe.setAttribute("nonce", u);
                const I = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (I ? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), s ? .remove()) : f ? (this.iframeContainer.appendChild(this.iframe), s ? .remove()) : (this.iframeContainer.appendChild(this.iframe), g.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function(t, e, i) {
                    ...
                    t.style.height = w, t.style.lineHeight = w, void 0 !== v && (t.style.width = v), t.style.textAlign = "center", t.style.verticalAlign = "middle",
                        t.innerHTML = m.innerHTML, this.iframeContainer.appendChild(t)
                }
            }
            _iframeSrcBase(t) {
        ...
        new class extends u {
            ...
            get propertiesToWorkWith() {
                return ["symbols", "linkPageTemplate", "largeChartUrl", "timeframe", "locale", "customer", "colorTheme", "isTransparent", "showSymbolLogo"]
            }
            filterRawSettings(t) {
                const e = super.filterRawSettings(t);
                return e.width = "100%", e.height = this._calculateHeight(), e
            }
            _calculateHeight() {
                let t = 0;
                const e = this.iframeContainer.querySelector(".tradingview-widget-copyright"),
                    i = this.iframeContainer.querySelector("#tradingview-copyright");
                if (e || i) {
                    t += 32
                }
                return t += 72, t
