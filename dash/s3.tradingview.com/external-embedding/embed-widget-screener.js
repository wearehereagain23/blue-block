(() => {
    ...
    function r(i) {
        ...
        const h = "https://www.tradingview-widget.com",
            d = "BATTLE";
        ...
        class u {
            ...
            _replaceScript(r) {
                ...
                const u = s.nonce || s.getAttribute("nonce"),
                    ...
                    m = g.querySelector(".tradingview-widget-copyright");
                this._copyrightContainer = p || m;
                const f = g.classList.contains("tradingview-widget-container");
                this.iframeContainer = g && f ? g : document.createElement("div"), o && (this.settings = this.filterRawSettings(o)), o && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"), this.settings = this.filterRawSettings(this.defaultSettings));
                const w = "32px",
                    {
                        width: y,
                        height: S
                    } = this.settings,
                    b = void 0 === S ? void 0 : `${S}${Number.isInteger(S)?"px":""}`,
                    v = void 0 === y ? void 0 : `${y}${Number.isInteger(y)?"px":""}`;
                if (void 0 !== v && (this.iframeContainer.style.width = v), void 0 !== b && (this.iframeContainer.style.height = b), this.shouldAddCopyrightStyles()) {
                    const t = function() {
                ...
                const _ = this.hasCopyright() ? `calc(100% - ${w})` : "100%",
                    T = location.hostname,
                    C = m ? "widget_new" : "widget",
                    k = this.widgetUtmName();
                this.settings.utm_source = T, this.settings.utm_medium = C, this.settings.utm_campaign = k, this._updateCopyrightHrefParams(T, C, k);
                const A = this.settings.iframeTitle || `${this.widgetId.replace("-"," ")} TradingView widget`,
                    E = this.settings.iframeLang || "en";
                this.iframe = this._createIframe(_, c, a, A, E), this._addCSPErrorListener(c), u && this.iframe.setAttribute("nonce", u);
                const I = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (I ? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), s ? .remove()) : f ? (this.iframeContainer.appendChild(this.iframe), s ? .remove()) : (this.iframeContainer.appendChild(this.iframe), g.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function(t, e, r) {
                    ...
                    t.style.height = w, t.style.lineHeight = w, void 0 !== v && (t.style.width = v), t.style.textAlign = "center", t.style.verticalAlign = "middle",
                        t.innerHTML = p.innerHTML, this.iframeContainer.appendChild(t)
                }
            }
            _iframeSrcBase(t) {
            ...
            _setSettingsQueryString(t) {
                const e = this.propertiesToAddToGetParams.filter((t => -1 !== g.indexOf(t))),
                    r = function(t, e) {
        ...
        new class extends u {
            ...
            get propertiesToWorkWith() {
                return ["colorTheme", "customer", "defaultColumn", "defaultScreen", "displayCurrency", "height", "largeChartUrl", "locale", "market", "screener_type", "showToolbar", "isTransparent", "width"]
            }
            filterRawSettings(t) {
                const e = super.filterRawSettings(t);
                return void 0 !== t.transparency && (e.isTransparent = t.transparency), "crypto_mkt" === e.screener_type && (e.market = "crypto"), e.enableScrolling = !0, e
            }
        }
    })()
})();