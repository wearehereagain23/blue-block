...
M.anime = function () {
    ...
    function (i, n) {
        ...
        var t = {
            ...
            e = function () {
                ...
                return _createClass(s, [{
                    ...
                    key: "_onDragStart",
                    value: function (t) {
                        if (t.target && i(t.target).closest(".toast_").length) {
                            var e = i(t.target).closest(".toast_")[0].M_Toast;
        ...
        e._toasts = [], e._container = null, e._draggedToast = null, M.toast__ = e, M.toast__ = function (t) {
            return new e(t)
        }
    }(cash, M.anime),
    function (s, o) {
        ...
        var e = {
            ...
            t = function (t) {
                ...
                return _inherits(n, Component), _createClass(n, [{
                    ...
                    value: function () {
                        var t = document.createElement("div");
                        t.classList.add("drag-target_"), document.body.appendChild(t), this.dragTarget = t
                    }
                }, {
        ...
        var e = {
            ...
            t = function (t) {
                ...
                return _inherits(n, Component), _createClass(n, [{
                    ...
                    value: function () {
                        var n = this;
                        this.wrapper = document.createElement("div"), d(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(d(this.wrapper)), this.wrapper.appendChild(this.el), this.$selectOptions = this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), d(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.$selectOptions.length && this.$selectOptions.each(function (t) {

                        }),
                            this.$el.after(this.dropdownOptions), this.input = document.createElement("input"), d(this.input).addClass("select-dropdown dropdown-trigger"), this.input.setAttribute("type", "text"), this.input.setAttribute("readonly", "true"), this.input.setAttribute("data-target", this.dropdownOptions.id), this.el.disabled && d(this.input).prop("disabled", "true")
...
"undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function (e) {
    ...
    Array.prototype.slice.call(e.querySelectorAll("pre[data-src]")).forEach(function (e) {
        if (!e.hasAttribute("data-src-loaded")) {
            ...
            l.open("GET.html", a, !0), l.onreadystatechange = function () {
                ...
                if ("undefined" != typeof window) {
                    ...
                    if (t instanceof Array)
                        if ("number" == typeof e.lookupFromPathIndex) {
                            ...
                            o = t[e.lookupFromPathIndex].replace("../index.html", "")
                        } else o = t[0].replace("../index.html", "")
                }
                return o
            }
        },
